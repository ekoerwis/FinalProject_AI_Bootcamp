...
Original file is located at
    https://colab.research.google.com/drive/1sQFhPgwEx_kZtxGJMl2QbfPGNLyITfMt
...
FOLDER_PATH     = "/content/drive/MyDrive/Colab Notebooks/FinalProject_AI_Bootcamp/Data/Input/Katering Yeyeti"
